...
export default function Footer() {
  return (
    <footer className="bg-white dark:bg-flat-gold text-flat-gold dark:text-custom-black py-4 mt-auto border-t-2 border-flat-gold">
      <div className="container grid gap-8 grid-cols-6 ml-10">
        {/* left */}
        <div>
          <h3 className="text-xl font-semibold mb-4">Contact Us</h3>
          <p className="flex items-center gap-2"> {/*mail*/}
            vsbc@vanderbilt.edu
          </p>
          <p className="flex items-center gap-2 mt-2"> {/*map*/}
            Nashville, TN 37235
          </p>
        </div>
        ...
        <div>
          ...
          >
            <div className="text-md mb-1 underline hover:text-blue-400 ">
              Individuals
            </div>
          </a>
          <a
            ...
            rel="noopener noreferrer"
          >
            <div className="text-md underline hover:text-blue-400 ">
              Organizations
            </div>
          </a>
        </div>
