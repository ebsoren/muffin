    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg p-8 max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          <div className="text-2xl font-bold text-gray-900 dark:text-white">Register</div>
          <button
            onClick={onClose}
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
          Register using your Google account. This will authenticate you with both Google and Supabase simultaneously.
        </p>
