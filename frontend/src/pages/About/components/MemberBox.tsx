...
export function MemberBox({ member }: MemberProps) {
  ...
  return (
    <div className="flex flex-col items-center text-center">
      {/* Circular Image */}
      <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-full overflow-hidden mb-3 sm:mb-4 shadow-lg">
        <img 
      ...
      <div className="flex items-center justify-center mb-2 px-2">
        <div className="text-sm sm:text-base md:text-lg font-semibold text-custom-black dark:text-white mr-2">
          {member.name}
        </div>
        {member.linkedIn && (
        <a 
