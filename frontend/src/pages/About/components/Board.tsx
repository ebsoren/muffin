...
export default function Board() {
  ...
  return (
    <div className="w-full bg-white dark:bg-custom-black duration-200 py-6 sm:py-8 px-4">
        <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-flat-gold dark:text-white mb-6 sm:mb-8 text-center">
          Executive Board
        </div>
        ...
        {boardMembers.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 pt-6 sm:pt-8 gap-4 sm:gap-6">
