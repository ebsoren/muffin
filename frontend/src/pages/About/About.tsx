...
export function About() {
  ...
  return (
    <div className="min-h-screen w-full bg-white duration-200">
      <div className="text-xl sm:text-2xl lg:text-3xl text-center text-flat-gold py-8 sm:py-10 px-4 sm:px-6 md:px-8 font-medium">
